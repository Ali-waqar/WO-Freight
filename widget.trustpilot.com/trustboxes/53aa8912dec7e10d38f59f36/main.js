! function i(n, a, s) {
    ...
    1: [function(e, t, r) {
        ...
        var d = e("@trustpilot/trustbox-framework-vanilla/modules/slider"),
            ...
            h = e("@trustpilot/trustbox-framework-vanilla/modules/templates/logo"),
            g = e("@trustpilot/trustbox-framework-vanilla/modules/templating"),
            w = e("@trustpilot/trustbox-framework-vanilla/modules/templates/summary"),
            y = s(e("@trustpilot/trustbox-framework-vanilla/modules/reviewFilterText")),
            b = s(e("./styleFirstVisibleReview")),
        ...
        function o(e) {
            var t, r, i, n, a, s, o, l, u, c = e.baseData,
                e = e.locale;
            c.settings.customStylesAllowed && (j && (0, f.setFont)(j), _ && (0, f.setTextColor)(_)), 0 === c.businessEntity.numberOfReviews.total ? (o = {
                baseData: c,
                url: I(c.links.evaluateUrl)
            ...
            }]), o = I(n), r.href = o, (a = document.querySelector("#translations-basedon a")) && (a.href = o), (0, f.addEventListener)(r, "click", L("LogoClick")), l.reviews && 0 < l.reviews.length && (t = (0, y.default)(u, N, T), s = document.getElementById("tp-widget-reviews-filter-label"), (0, f.setTextContent)(s, t)), c.reviews && 0 < c.reviews.length && (i = {
                locale: e,
                reviews: c.reviews
                ...
                return (0, v.populateElements)([{
                    element: e,
                    string: (0, g.mkElemWithSvgLookup)("arrowSlider")
                }, {
                    element: e,
                    string: (0, g.mkElemWithSvgLookup)("arrowSlider")
                }])
            ...
            }).initialize(), new b.default(i, a.slider).initialize()))
        }
        var L = function(e) {
                return function() {
        ...
        (0, e.default)(function() {
            return (0, n.fetchServiceReviewData)(R)(O, o)
        })
    }, {
    ...
    63: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.showTrustBox = r.setTextContent = r.setTextColor = r.setFont = r.setHtmlContent = r.sanitizeHtml = r.sanitizeColor = r.removeElement = r.makeTranslations = r.handlePopoverPosition = r.insertNumberSeparator = r.getOnPageReady = r.addUtmParams = r.addEventListener = void 0;
        var a = function(e, t) {
                if (Array.isArray(e)) return e;
                if (Symbol.iterator in Object(e)) {
                    var r = t,
        ...
        }, r.sanitizeHtml = o, r.setHtmlContent = function(e, t) {
        ...
        r.default = function(o) {
            ...
            return function(e) {
                ...
                return (0, c.div)({
                    ...
                    num: e.stars,
                    color: r.starColor
                })), (s = o, r = e, (s = (0, h.default)(s, r)).labelType === m.LabelTypes.NOT_VERIFIED ? "" : (r = (0, c.div)({
                    class: "label-icon"
                }, [s.icon(), g(s)]), s = (0, c.div)({
                    class: "label-text"
                }, s.label()), (0, c.div)({
    ...
    17: [function(e, t, r) {
        ...
        var i = R(e("./da-DK/strings.json")),
            ...
            h = R(e("./fr-FR/strings.json")),
            g = R(e("./it-IT/strings.json")),
            w = R(e("./ja-JP/strings.json")),
            y = R(e("./nb-NO/strings.json")),
            b = R(e("./nl-BE/strings.json")),
            L = R(e("./nl-NL/strings.json")),
            I = R(e("./pl-PL/strings.json")),
            E = R(e("./pt-BR/strings.json")),
        ...
        function o(o) {
            return function(e, t, r, i) {
                var n = e[Object.keys(e)[0]],
                    ...
                    n = n.theme,
                    s = void 0 === n ? "light" : n,
                    n = (0, f.promiseAllObject)((0, f.mapObject)(h(o), e)),
        ...
        function a(e, t) {
            var r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {},
                i = Object.keys(r).reduce(function(e, t) {
                    return e[t] = (0, n.sanitizeHtml)(r[t]), "color" === t && (e[t] = (0, n.sanitizeColor)(e[t])), e
                }, {});
    ...
    62: [function(e, t, r) {
        ...
        var c = {
            ...
            m = (n(h, [{
                ...
                key: "label",
                value: function() {
                    return u(this.locale)[this.labelType].label()
                }
            }, {
                key: "tooltipTitle",
                value: function() {
                    return u(this.locale)[this.labelType].infoTitle()
                }
            }, {
                key: "tooltipContent",
                value: function() {
                    return e = this.locale, l(t = {}, p.NOT_VERIFIED, {
                        info: function() {
                            return ""
                        }
                    }), l(t, p.VERIFIED_AUTOMATIC, {
                        info: function() {
                ...
                value: function() {
                    var e;
                    return (e = u(this.locale)[this.labelType].icon) && (0, o.mkElemWithSvgLookup)(e)
                }
            }]), h);
        ...
        function g(e) {
            function t() {
                return -1 !== [d.KICKSTART, d.COPY_PASTE_INVITATION, d.FILE_UPLOAD_INVITATION, d.MANUAL_INPUT_INVITATION].indexOf(s)
            }

            function r() {
                var e = [d.INVITATION_LINK_API, d.BUSINESS_GENERATED_LINK, d.LEGACY_UNIQUE_LINK, d.UNIQUE_LINK, d.EMBEDDED_BUSINESS_GENERATED_LINK_FORM, d.EMBEDDED_UNIQUE_LINK_FORM],
                    t = new Date(n),
            ...
            if (o) switch (o) {
                case c.VERIFIED:
                    return l === v.COMPLIANCE_DOCUMENTATION ? new m(f.VERIFIED, p.VERIFIED_DOE, i) : new m(f.VERIFIED, p.VERIFIED_AUTOMATIC, i);
                case c.INVITED:
                    if (t()) return new m(f.INVITED, p.INVITED_MANUAL, i);
                    if (r()) return new m(f.INVITED, p.INVITED_SELF_INVITER, i);
                    if (s === d.BASIC_LINK) return new m(f.NOT_VERIFIED, p.NOT_VERIFIED, i);
                    break;
                case c.REDIRECTED:
                    return new m(f.REDIRECTED, p.REDIRECTED, i);
                case c.NOT_VERIFIED:
                    return new m(f.NOT_VERIFIED, p.NOT_VERIFIED, i)
            }
            return a ? l === v.COMPLIANCE_DOCUMENTATION ? new m(f.VERIFIED, p.VERIFIED_DOE, i) : t() ? new m(f.INVITED, p.INVITED_MANUAL, i) : r() ? new m(f.INVITED, p.INVITED_SELF_INVITER, i) : new m(f.VERIFIED, p.VERIFIED_AUTOMATIC, i) : s !== d.BASIC_LINK && s === d.DOMAIN_LINK ? new m(f.REDIRECTED, p.REDIRECTED, i) : new m(f.NOT_VERIFIED, p.NOT_VERIFIED, i)
        }
        r.default = function(e, t) {
            return g(i({
                locale: e
