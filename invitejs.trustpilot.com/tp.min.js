! function(t) {
    ...
    ! function(t) {
        ...
        function a(t, e) {
            return "5419b6a8b0d04a076446a9ad" == t ? "dark" == e ? "border: 1px solid #383838;border-radius: 3px;background: linear-gradient(to bottom, #404040 0%, #505050 100%);padding-top: 7px;" : "border: 1px solid #eee;border-radius: 3px;background: linear-gradient(to bottom, #fff 0%, #f5f5f5 100%);padding-top: 7px;" : ""
        }
        ...
        function s(t, e) {
            ...
            n.withCredentials = !0, n.open("POST", t, !0), n.responseType = "json", n.setRequestHeader("Content-Type", "application/json"), n.onreadystatechange = function() {
        ...
        function u(e, n, r) {
            ...
            if (!n.recipientEmail) {
                const o = {
                    ...
                    localStorage: {
                        tpinvId: localStorage.getItem("tpinvid")
                    },
                    sessionStorage: {
            ...
            i.withCredentials = !0, i.open("POST", e, !0), i.setRequestHeader("Content-Type", "application/json"), i.onreadystatechange = function() {
                ...
                var p = function() {
                        ...
                        function c(t, n) {
                            ...
                            var o = (new DOMParser).parseFromString(r, "text/html"),
                                ...
                                s = t.zindex || 1e3,
                                u = t.clear || "none";
                            a.setAttribute("id", n), a.setAttribute("style", "z-index: " + s + " !important;"), t.sku && a && a.hasAttribute("data-sku") && a.setAttribute("data-sku", t.sku), t.name && a && a.getAttribute("data-name") && a.setAttribute("data-name", t.name);
                            var l = document.createElement("DIV");
                            if (l.setAttribute("id", n + "-wrapper"), l.setAttribute("style", "z-index: " + s + "; clear: " + u + ";"), "before" === t.position || "after" === t.position) {
                                var d = l.getAttribute("style");
                                t.paddingx && (d += "margin-left: " + t.paddingx + "px; margin-right:  " + t.paddingx + "px;"), t.paddingy && (d += "margin-top: " + t.paddingy + "px; margin-bottom: " + t.paddingy + "px;"), l.setAttribute("style", d)
                            }
                            return "floating" === t.position && l.setAttribute("style", "position: fixed !important; z-index: 1000; " + i(t.corner, t.paddingx || 0, t.paddingy || 0)), l.appendChild(a), l
                        }

                        function f(t, e) {
                            for (var n = null, r = [t.repeatXpath.xpathById.prefix.slice(0, -1), t.repeatXpath.xpathFromRoot.prefix.slice(0, -1)], i = 0; i < r.length && !(n = document.evaluate(r[i], document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue); i++);
                            if (!n) return [];
                        ...
                        function h(t, e, n) {
                            ...
                            if ("floating" === t.position) document.body.appendChild(r), b(r);
                                ...
                                var i = null;
                                if (t.xpath) i = document.evaluate(atob(t.xpath), document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
                                else if (t.xpaths)
                                    for (var o = n ? JSON.parse(atob(t.xpaths)) : t.xpaths, a = 0; a < o.length && !(i = document.evaluate(o[a], document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue); a++);
                                i && ("LI" == i.tagName ? ("before" === t.position ? i.insertBefore(r, i.firstChild) : i.appendChild(r), b(r)) : ("before" == t.position ? i.parentNode.insertBefore(r, i) : i.parentNode.insertBefore(r, i.nextSibling), b(r)))
                            }
                        }
                                            ...
                                            if (o.repeat && o.repeatXpath && t.categoryProductsData && t.categoryProductsData.length > 1)
                                                for (var a = 0; a < t.categoryProductsData.length; a++) {
                                                    var s = t.categoryProductsData[a],
                                                        u = f(o, s);
                                                    u.length > 0 && (o.xpaths = u, o.name = s.name, o.sku = v(s), h(o, e, !1), r++, e = "trustpilot-widget-trustbox-" + r)
                                                } else h(o, e, !0), r++
                                        }
                        ...
                        return y.prototype = {
                            ...
                            injectTrustBoxWidget: function() {
                                ...
                                n.setAttribute("href", E.weblink), n.setAttribute("target", "_blank"), n.appendChild(t.document.createTextNode("Trustpilot"));
                                var i = t.document.createElement("DIV");
                                i.setAttribute("class", "trustpilot-widget"), i.setAttribute("data-locale", w.locale), i.setAttribute("data-template-id", w.template), i.setAttribute("data-theme", w.theme), i.setAttribute("data-businessunit-id", E.businessUnitId), i.setAttribute("data-style-height", w.height), i.setAttribute("data-style-width", "100%");
                                var o = t.document.createElement("DIV");
                                o.setAttribute("style", "position: fixed !important; z-index: 1000; " + w.background + w.position), i.appendChild(n), o.appendChild(i), t.document.body.appendChild(o), b(o), e(null)
                            },
                            createInvitation: function(t) {
                                ...
                                n(1).load(function(n) {
                                    t.simplicity = n, u(i, t, function(n, r) {
                                        if (n) return void e(new Error("Failed to create invitation: " + n));
                                        202 === r && (t.products = o || [], t.productSkus = a || [], u(i, t, function(t) {
                            ...
                            loadTrustBoxWidget: function(t) {
                                ...
                                S || e(new Error('Key is not set, call "register" function first')), w.locale = t.locale, w.theme = t.theme, w.template = t.template, w.position = i(t.position, t.paddingx, t.paddingy), w.background = a(t.template, t.theme), w.height = o(t.template);
                                ...
                                if (n) E = JSON.parse(n), e(null), this.injectTrustBoxWidget();
                                    ...
                                    s("https://invitejs.trustpilot.com/api/" + S + "/trustboxconfig", function(t, n) {
                                        ...
                                        E.businessUnitId = t.BusinessUnitId, E.weblink = t.Url, sessionStorage.trustBoxSettings = JSON.stringify(E), e(null), u.injectTrustBoxWidget()
                                    })
                                }
                            },
                            trustBox: function(e) {
                                "complete" !== document.readyState && t.addEventListener("load", function() {
                                        x(e)
                                    }), x(e),
                                    function(t) {
                                        r("trustBox", t)
                    ...
                    c = t[l] || {};
                c.q = c.q || [], e(p, c.q), Object.freeze(p), t[l] = function() {
                    e(p, [arguments])
                }, t[l].api = p, Object.freeze(t[l]), r("load")
            }()
        }
    }(window)
}, function(t, e) {
    t.exports.load = function(t) {
        function e(t) {
            ...
            e.style.display = "none", e.src = "https://simplicity.trustpilot.com/embed", document.body.appendChild(e), window.addEventListener("message", function(e) {
